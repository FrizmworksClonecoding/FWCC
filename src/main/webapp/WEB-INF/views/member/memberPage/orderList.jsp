	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
			...
			<head>
				...
				<link rel="stylesheet" href="/css/member/memberPage/orderList.css">
				<!-- CDN example (unpkg) -->
			...
			<body>
						...
						<div class="xans-element- xans-myshop xans-myshop-orderhistorytab ec-base-tab ">
							<ul class="menu">
								...
								<li class="tab_class_cs"><a href="#">취소/반품/교환 내역 (<span
											id="xans_myshop_total_orders_cs">0</span>)
									</a></li>
							</ul>
						</div>
						<!-- 검색 필터 START -->
						<form action="./filteredList" method="GET">
							...
							>
								...
								<option value="4">취소</option>
									...
									<span class="period"> <a href="#" id="btn01" class="btnNormal" days="00"><img
												src="//img.echosting.cafe24.com/skin/base_ko_KR/myshop/btn_date1.gif"
												alt="오늘" /></a> <a href="#" id="btn07" class="btnNormal" days="07"><img
												src="//img.echosting.cafe24.com/skin/base_ko_KR/myshop/btn_date2.gif"
												alt="1주일" /></a> <a href="#" id="btn30" class="btnNormal" days="30"><img
												src="//img.echosting.cafe24.com/skin/base_ko_KR/myshop/btn_date3.gif"
												alt="1개월" /></a> <a href="#" id="btn90" class="btnNormal" days="90"><img
												src="//img.echosting.cafe24.com/skin/base_ko_KR/myshop/btn_date4.gif"
												alt="3개월" /></a> <a href="#" id="btn180" class="btnNormal"
											days="180"><img
												src="//img.echosting.cafe24.com/skin/base_ko_KR/myshop/btn_date5.gif"
												alt="6개월" /></a>
									</span> <input id="history_start_date" name="startDate" class="fText" size="10"
										value="" type="text" /> ~ <input id="history_end_date" name="endDate"
										class="fText" size="10" value="" type="text" />
									<button>
										<img alt="조회"
				...
				/> -->
								...
								<c:if test="${list != null}">
									<tbody>
										<c:forEach items="${list}" var="VO">
											<tr>
												<td><img src="${pageContext.request.contextPath}/resources/images/product/${VO.productVO.productNum}/${VO.fileName}"
														alt="img" /></td>
												...
												<td>
													<c:if test="${VO.orderlistVO.orderState == 1}">
														<a href="#" class="orderCancle"
															data-orderNum='${VO.orderlistVO.orderNum}'><img
						...
						<div class="xans-element- xans-myshop xans-myshop-orderhistorypaging ec-base-paginate">
							<a href="#" class="first">&lt;</a> <a href="#">PREV</a>
							<ol>
								<li class="xans-record-"><a href="#" class="this">1</a></li>
							</ol>
							<a href="#">NEXT</a> <a href="#" class="last">&gt;</a>
						</div>
						<!-- pager END -->
					</div>
				</div>
				...
				<script type="text/javascript"
					src='${pageContext.request.contextPath}/js/order/orderCancle.js'></script>
			</body>
