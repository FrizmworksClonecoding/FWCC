	...
	<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
			...
			<head>
				...
				<link rel="stylesheet" href="/css/member/memberPage/memberAddress.css">
				<meta charset="UTF-8">
			...
			<body>
					...
					<div id="contents">
						...
						<div class="xans-element- xans-myshop xans-myshop-addrlist">
										...
										<tbody class=" center">
											<c:forEach items="${list}" var="VO">
												<tr class="xans-record-">
													<td><input value="" name="addressSelect" class="check"
															type="checkbox" title="${VO.addrNum}" /></td>
													<td><a href="#"><img
													...
													<td class="left"><img
															...
															class="displaynone" alt="기본" /> <span
															class="">${VO.addrName}</span></td>
													<td class="left"><span class="">${VO.recipient}</span></td>
													<td class="left"><span class="">${VO.addrPhone}</span></td>
													<td class="left">(<span class="">${VO.zipCode}</span>) <span
															class="">${VO.basicAddr}</span>
														<span class="">${VO.detailAddr}</span>
													</td>
													<td>
														<form action="./addressModify" method="GET">
															<input hidden="" name="addrNum" value="${VO.addrNum}" />
															<button>
																<img src="//img.echosting.cafe24.com/skin/base_ko_KR/myshop/btn_address_modify.gif"
																	class="" alt="수정" />
															</button>
														</form>
													</td>
							...
							<div class="ec-base-button">
								<span class="gLeft "> <a href="#"><img id="deleteAddr"
						...
						<div class="ec-base-help">
							...
							<div class="inner">
								<ol>
									<li class="item1">배송 주소록은 최대 10개까지 등록할 수 있으며, 별도로 등록하지 않을 경우 최근 배송 주소록 기준으로 자동 업데이트
										됩니다.</li>
				...
				<!-- Custom JS -->
				<script type="text/javascript" src="/js/member/memberPage/memberAddress.js"></script>
