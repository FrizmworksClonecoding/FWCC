	...
	<ul style="padding-left:none; list-style: none;">
		<li style="float: right; padding:1.7%;">
			...
			<ul id="adminMenuBar" 
				...
				<li style="margin-top:7%;"><a href="${pageContext.request.contextPath}/" 
												style="text-decoration: none; color: white;">메인 페이지로 이동</a></li>
				<li style="margin-top:10%;"><a href="${pageContext.request.contextPath }/member/memberLogout" 
													style="text-decoration: none; color: white;">로그아웃</a></li>		
			</ul>
		</li>
